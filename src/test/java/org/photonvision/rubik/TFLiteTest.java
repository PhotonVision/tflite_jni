...
public class TFLiteTest {
    public void testModel(String modelPath, String imagePath, int modelVersion) {
        try {
            ...
            long ptr = TFLiteJNI.create(modelPath, modelVersion);
    ...
    public void memLeakFinder() {
        ...
        for (int i = 0; i < numRuns; i++) {
            ...
            long ptr = TFLiteJNI.create("src/test/resources/models/yolov8nCoco.tflite", 0);
    ...
    public void benchmark() {
        ...
        System.out.println("Creating TFLite detector");
        long ptr = TFLiteJNI.create("src/test/resources/models/yolov8nCoco.tflite", 1);
